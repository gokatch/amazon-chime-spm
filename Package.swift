...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "AmazonChimeSDK",
            url: "https://github.com/gokatch/amazon-chime-spm/raw/main/AmazonChimeSDK.xcframework.zip",
            checksum: "cc7cd2f951c17c43a497d2f703db7daa3ccd7195e40fc83fd3e4687882b7da46"
        ),
        .binaryTarget(
            name: "AmazonChimeSDKMedia",
            url: "https://github.com/gokatch/amazon-chime-spm/raw/main/AmazonChimeSDKMedia.xcframework.zip",
